...
local function url()
    local current='temperature_2m,relative_humidity_2m,surface_pressure,precipitation,weather_code,cloud_cover,visibility,wind_speed_10m,wind_direction_10m,wind_gusts_10m'
    local hourly='temperature_2m,relative_humidity_2m,surface_pressure,weather_code,precipitation,cloud_cover,visibility,wind_speed_10m,wind_direction_10m,wind_gusts_10m'
